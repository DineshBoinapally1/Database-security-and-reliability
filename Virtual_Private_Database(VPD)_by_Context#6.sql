...
CREATE OR REPLACE FUNCTION DBSEC_ROW_OWNER_FUNCTION( P_SCHEMA IN VARCHAR2, P_OBJECT IN VARCHAR2 ) 
RETURN VARCHAR2 AS BEGIN IF (USER = 'DBSEC') THEN RETURN''; 
ELSE
...
POLICY_FUNCTION => 'DBSEC_ROW_OWNER_FUNCTION',  
...
SELECT COUNT ( * ) FROM DBSEC.CUSTOMER;